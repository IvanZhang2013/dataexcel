...
public class ProcUtils {
	...
	private static BaseDataConnection baseDataConnection;

	public static ProcMessge operProc(ProcBean procBean) throws Exception {
		String procSql = procSql(procBean);
	...
	private static String procSql(ProcBean procBean) {
	...
	public void setBaseDataConnection(BaseDataConnection baseDataConnection) {
		ProcUtils.baseDataConnection = baseDataConnection;
	}
